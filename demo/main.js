...
const pcm = new PCMPlayer({ channels: 1, sampleRate: 16000, flushIntervalMs: 100 });
  ...
  socket.onopen = () => {
    ...
    const sessionCreateMessage = {
      ...
      config: {
        ...
        tts_config: { voice: voiceGenderSelect.value === 'male' ? 'onwK4e9ZLuTAKqWW03F9' : (voiceGenderSelect.value === 'female' ? 'XrExE9yKIg1WjnnlVkGX' : undefined), format: 'pcm' },
